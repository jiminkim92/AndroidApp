...
public class MainActivity extends AppCompatActivity {
    ...
    // 가상 핸드폰을 제공(설치)
    // 웹 : html/css 리소스 + java코드(기능)
    // 모바일앱 : xml리소스 + java코드(기능부여)
    // windows프로그램 : re리소스 + c#코드(기능부여)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        super.onCreate(savedInstanceState);    // AppcompotActivity 부모 클래스의 onCreate 메서드 실행
        setContentView(R.layout.activity_main);    // res 폴더 안에 Layout 폴더 안에 activity_main.xml화면을 실행
